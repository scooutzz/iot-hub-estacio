...
class BlobUploader {
    ...
    uploadToBlob(blobInfo, stream, streamLength, done) {
        (0, azure_iot_common_2.tripleValueCallbackToPromise)((_callback) => {
            ...
            const uploadPromise = newBlockBlobClient.uploadStream(stream, 4 * 1024 * 1024, 20, { abortSignal: abort_controller_1.AbortController.timeout(30 * 60 * 1000) });
            uploadPromise
