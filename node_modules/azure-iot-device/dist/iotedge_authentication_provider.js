...
exports.IotEdgeAuthenticationProvider = exports.WORKLOAD_API_VERSION = void 0;
 ...
 */
class IotEdgeAuthenticationProvider extends sak_authentication_provider_1.SharedAccessKeyAuthenticationProvider {
    /**
     * @private
     *
     ...
     */
    constructor(_authConfig, tokenValidTimeInSeconds, tokenRenewalMarginInSeconds) {
        ...
        }, tokenValidTimeInSeconds, tokenRenewalMarginInSeconds);
        ...
        this._restApiClient = new azure_iot_http_base_1.RestApiClient(config, `${packageJson.name}/${packageJson.version}`);
    }
    getTrustBundle(callback) {
        ...
        const path = `/trust-bundle?api-version=${(0, azure_iot_common_1.encodeUriComponentStrict)(exports.WORKLOAD_API_VERSION)}`;
    ...
    _sign(resourceUri, expiry, callback) {
        ...
        const path = `/modules/${(0, azure_iot_common_1.encodeUriComponentStrict)(this._authConfig.moduleId)}/genid/${(0, azure_iot_common_1.encodeUriComponentStrict)(this._authConfig.generationId)}/sign?api-version=${(0, azure_iot_common_1.encodeUriComponentStrict)(exports.WORKLOAD_API_VERSION)}`;
        ...
        azure_iot_common_1.SharedAccessSignature.createWithSigningFunction(this._credentials, expiry, (buffer, signCallback) => {
            ...
            this._restApiClient.executeApiCall('POST', path, { 'Content-Type': 'application/json' }, signRequest, this._getRequestOptions(), (err, body, _response) => {
                if (err) {
