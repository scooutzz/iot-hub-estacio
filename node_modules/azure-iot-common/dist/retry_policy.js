...
exports.NoRetry = exports.ExponentialBackOffWithJitter = exports.ExponentialBackoffWithJitterParameters = void 0;
const retry_error_filter_1 = require("./retry_error_filter");
/**
...
jd = 0.5
```]*/
class ExponentialBackoffWithJitterParameters {
    constructor() {
        /**
...
class ExponentialBackOffWithJitter {
     ...
     */
    constructor(immediateFirstRetry, errorFilter) {
     ...
     */
    nextRetryTimeout(retryCount, isThrottled) {
