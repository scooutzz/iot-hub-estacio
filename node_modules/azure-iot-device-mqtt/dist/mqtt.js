...
class Mqtt extends events_1.EventEmitter {
    ...
    _getBaseTransportConfig(credentials) {
        ...
        let apiVersionString = azure_iot_common_1.endpoint.versionQueryString();
    ...
    _onC2DMessage(topic, payload) {
        ...
        let msg = new azure_iot_common_1.Message(payload);
    ...
    _getEventTopicFromMessage(message, extraSystemProperties) {
        ...
        let systemProperties = extraSystemProperties || {};
